...
#### `model`: (model object) {.unnumbered}

Object fitted using the `statsmodels` formula API.


#### `variables`: (str, list, dictionary) {.unnumbered}
...
#### `newdata`: (None, DataFrame, str) {.unnumbered}
...
#### `by`: (bool, str, List[str], DataFrame, optional) {.unnumbered}
...
#### `hypothesis`: (str, int, float, list of str, numpy array) {.unnumbered}
...
#### `equivalence`: (list, optional) {.unnumbered}
