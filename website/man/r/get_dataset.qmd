...
<tr><td style = "white-space: collapse; font-family: monospace; vertical-align: top"><code id="package">package</code></td>
<td>
String. Package name that originally published the data.
</td></tr>
<tr><td style = "white-space: collapse; font-family: monospace; vertical-align: top"><code id="docs">docs</code></td>
<td>
Logical. If TRUE open the documentation using <code>getOption("viewer")</code> or the Rstudio viewer.
</td></tr>
<tr><td style = "white-space: collapse; font-family: monospace; vertical-align: top"><code id="search">search</code></td>
<td>
