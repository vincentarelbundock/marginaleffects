...
get_predict(model, newdata = get_modeldata(model), type = "class", ...)
...
get_predict(model, newdata = get_modeldata(model), type = "response", ...)
...
get_predict(model, newdata = get_modeldata(model), type = "prob", ...)

## S3 method for class 'clmm2'
get_predict(model, newdata = get_modeldata(model), type = "prob", ...)

## S3 method for class 'rq'
get_predict(model, newdata = get_modeldata(model), type = NULL, ...)
...
get_predict(model, newdata = get_modeldata(model), type = "lp", ...)

## S3 method for class 'clogit'
get_predict(model, newdata = get_modeldata(model), type = "choice", ...)
