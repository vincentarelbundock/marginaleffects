...
<code>WeightIt::glm_weightit()</code> or <code>WeightIt::lm_weightit()</code> are supported because
their <code>estfun()</code> and <code>bread()</code> methods already account for estimation of the
weights; the multi-equation <code>multinom_weightit</code>, <code>ordinal_weightit</code>, and
<code>coxph_weightit</code> classes are not supported.
