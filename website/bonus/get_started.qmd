...
2. _Predictors:_ What regressor values are we interested in? Do we want to produce estimates for the units in our dataset, or for hypothetical or representative individuals? 
...
Alternatively, you can install the development version for `R` from GitHub:
...
[_Predictions_:](https://marginaleffects.com/chapters/predictions.html)
...
[_Comparisons_:](https://marginaleffects.com/chapters/comparisons.html)
...
[_Slopes_:](https://marginaleffects.com/chapters/slopes.html) 
...
See the [Comparisons vignette for detailed explanations and more options.](https://marginaleffects.com/chapters/comparisons.html)
...
The [`datagrid` function gives us a powerful way to define a grid of predictors.](https://marginaleffects.com/man/r/datagrid.html) All the variables not mentioned explicitly in `datagrid()` are fixed to their mean or mode:
...
* [`plot_predictions`](https://marginaleffects.com/man/r/plot_predictions.html): Conditional Adjusted Predictions
* [`plot_comparisons`](https://marginaleffects.com/man/r/plot_comparisons.html): Conditional Comparisons
* [`plot_slopes`](https://marginaleffects.com/man/r/plot_slopes.html): Conditional Marginal Effects
...
The [Standard Errors vignette](https://marginaleffects.com/chapters/uncertainty.html) offers more detail. For now, it suffices to show two examples. First, we use the `vcov` argument to report "HC3" (heteroskedasticity-consistent) standard errors. 
...
See the [Hypothesis Tests and Custom Contrasts vignette](https://marginaleffects.com/chapters/hypothesis.html) for background, details, and for instructions on how to conduct hypothesis tests in more complex situations.
