...
* [`countreg` package](https://github.com/vincentarelbundock/marginaleffects/blob/main/r/sandbox/methods_countreg.R). Thanks to Olivier Beaumais.
* [`censreg` package](https://github.com/vincentarelbundock/marginaleffects/blob/main/r/sandbox/methods_censReg.R). Thanks to Oleg Komashko.
...
1. `set_coef()`
    ...
    - [Example](https://github.com/vincentarelbundock/marginaleffects/blob/main/r/R/set_coef.R)
1. `get_vcov()`
    - Mandatory arguments: `model`, `...`.
