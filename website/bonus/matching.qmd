...
3. Use `marginaleffects` and [G-Computation](https://marginaleffects.com/chapters/gcomputation.html) to estimate a quantity of interest, such as the Average treatment effect on the treated (ATT)
