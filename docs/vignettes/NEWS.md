...
-   `glmmTMB` models with zero-inflated components are supported. Thanks
...
Renamed functions (backward-compatibility is maintained by keeping the
...
-   `tidy.predictions()` and `tidy.marginalmeans()` get a new
