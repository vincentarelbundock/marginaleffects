...
1.  Use the observed data to fit a regression model with *Y* as outcome,
...
These simple commands do everything we need to apply the parametric
g-formula:
...
```
    ...
    1 Treatment - No Treatment 3.517374 0.4988764 2.539594  4.495154
