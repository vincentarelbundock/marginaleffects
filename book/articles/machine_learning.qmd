...
gla <- quantile(ames_train$Gr_Liv_Area, probs = seq(0, 1, length.out = 101))
nd <- datagridcf(Gr_Liv_Area = gla, newdata = ames_train)
...
We can replicate this plot using the `DALEX` package:
