...
Our article on `marginaleffects` is provisionally accepted for publication by the _Journal of Statistical Software_. You can read [the preprint here.](files/marginaleffects_arel-bundock_greifer_heiss_jss5115.pdf)

To cite `marginaleffects` in publications please use:

  Arel-Bundock V, Greifer N, Heiss A (Forthcoming). "How to Intepret Statistical Models Using marginaleffects in R and Python." _Journal of Statistical Software_.
