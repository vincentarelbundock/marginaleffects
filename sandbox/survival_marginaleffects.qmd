...
::: {.callout-warning}
This notebook reports uncertainty estimates obtained via bootstrap, using the `vcov="rsample"` argument. See the section on Uncertainty below for an important note on this topic.
:::
