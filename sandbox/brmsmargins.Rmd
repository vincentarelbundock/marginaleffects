...
* How are LL and UL computed? In `brmsfit$ContrastSummary` they do not match quantiles of the posterior.
* How is the Mdn column computed?
* Small numerical difference in the "integrate out" example.
* I need to look into the link scale and back-transform example
