testthat::skip_if_not_installed("gam")
...
expect_predictions2(mod_simple, se = FALSE) # backtransform
...
expect_predictions2(model, newdata = head(kyphosis), n_row = 6, se = FALSE)
