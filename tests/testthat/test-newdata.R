testthat::skip_if_not_installed("modelbased")
...
expect_equal(cmp$estimate, emm$estimate, tolerance = 1e-6, ignore_attr = TRUE)
...
# expect_error(slopes(mod, newdata = dat, by = "group"), regexp = "forbidden")
