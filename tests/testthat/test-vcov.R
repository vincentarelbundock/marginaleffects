...
test_that("vcov matrix produces different results", {
...
test_that("matrix vcov produces different results", {
    withr_library("marginaleffects")
    withr_library("sandwich")
...
test_that("marginaleffects vcov strings work correctly", {
    withr_library("marginaleffects")
    withr_library("sandwich")
...
test_that("predictions vcov strings work correctly", {
    withr_library("marginaleffects")
    withr_library("sandwich")
...
test_that("get_vcov function works correctly", {
    withr_library("marginaleffects")
    withr_library("sandwich")
