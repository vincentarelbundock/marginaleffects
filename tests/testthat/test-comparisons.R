test_that("comparisons: basic functionality", {
...
test_that("comparisons: custom functions", {
    # Issue #527
    dat <- mtcars
...
test_that("comparisons: ratio comparisons", {
    ...
    expect_equal(cmp$estimate, c2, ignore_attr = TRUE)
})

test_that("comparisons: cross comparisons with validation", {
    # Issue #1137
    ...
    expect_equal(cmp$estimate, -0.992857142857154, ignore_attr = TRUE)
...
test_that("comparisons: custom lift functions", {
    ...
    expect_equal(c1$estimate, c2$estimate, ignore_attr = TRUE)
    expect_equal(c1$estimate, c3, ignore_attr = TRUE)
})
