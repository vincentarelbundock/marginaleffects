test_that("joint hypotheses work with F test", {
...
test_that("joint hypotheses work with chi-squared test", {
    withr_library("marginaleffects")
    withr_library("car")
...
test_that("joint hypotheses work with numeric indices", {
    withr_library("marginaleffects")
    withr_library("car")
...
test_that("joint hypotheses work with regex indices", {
    withr_library("marginaleffects")
...
test_that("joint hypotheses work with marginaleffects objects", {
    withr_library("marginaleffects")
...
test_that("joint hypotheses work with null hypothesis vector", {
    withr_library("marginaleffects")
...
test_that("joint hypotheses work with different regex patterns", {
    withr_library("marginaleffects")
    ...
    h3 <- hypotheses(cmp, joint = TRUE)
         expect_equal(h1$estimate, h2$estimate, ignore_attr = TRUE)
     expect_equal(h1$estimate, h3$estimate, ignore_attr = TRUE)
     expect_equal(h1$std.error, h2$std.error, ignore_attr = TRUE)
     expect_equal(h1$std.error, h3$std.error, ignore_attr = TRUE)
})

test_that("joint hypotheses work with vcov argument", {
    withr_library("marginaleffects")
    withr_library("sandwich")
...
test_that("joint hypotheses work with complex models", {
    withr_library("marginaleffects")
