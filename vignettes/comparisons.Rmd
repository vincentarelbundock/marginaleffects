...
We can do a similar comparison, but instead of fixing a conditional grid, we can average over subgruops of the empirical distribution, using the `by` argument:
