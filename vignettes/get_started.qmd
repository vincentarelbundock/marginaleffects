...
There is *much* more you can do with `marginaleffects`. Click through he table of contents to read the many vignettes, starting with:
...
Then, move on to read the case studies and technical notes (see sidebar).
