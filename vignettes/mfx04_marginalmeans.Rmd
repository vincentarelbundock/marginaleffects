...
# Subgroup analyses with the `by` argument

We can compute marginal means within subgroups using the `by` argument:
...
marginalmeans(mod, by = "am")
```

# Custom Contrasts and Linear Combinations

See the vignette on [Custom Contrasts and Combinations](https://vincentarelbundock.github.io/marginaleffects/articles/lincom.html)
