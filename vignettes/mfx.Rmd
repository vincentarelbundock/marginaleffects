...
mod <- list(
    "Short model" = glm(large_penguin ~ flipper_length_mm, data = dat, family = binomial),
    "Long model" = glm(large_penguin ~ flipper_length_mm + bill_length_mm, data = dat, family = binomial))
