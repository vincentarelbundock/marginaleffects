...
The `FUN` argument can be used to compute standard errors for arbitrary functions of model parameters. This user-supplied function must a single model object and return a numeric vector or a data.frame with two columns named `term` and `value`.
