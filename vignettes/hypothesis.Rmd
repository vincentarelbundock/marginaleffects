...
avg_slopes(mod, variables = "hp") |>
    hypotheses(equivalence = c(-.1, .0))
```
```{r, include = FALSE}
hyp <- avg_slopes(mod, variables = "hp", equivalence = c(-.1, .0))$p.value.equ
```
...
#### Example 4: `comparisons()` with the `hypothesis` argument
