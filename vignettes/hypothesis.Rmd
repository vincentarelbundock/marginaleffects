...
1. The p value for the non-inferiority test is `r sprintf("%.4f", hyp$p.value.noninf)`. This suggests that we *can* reject the hypothesis that the parameter is below 17.
1. The p value for the non-superiority test is `r sprintf("%.4f", hyp$p.value.nonsup)`. This suggests that we *cannot* reject the hypothesis that the parameter (`r sprintf("%.4f", hyp$estimate)`) is below 18.
