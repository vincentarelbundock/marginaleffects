...
`marginaleffects` offers an *experimental* `inferences()` function to compute uncertainty estimates using the bootstrap and simulation-based inference.  The primary function to do this is `inferences()`. 
