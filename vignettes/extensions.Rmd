---
title: "Extending`marginaleffects`" 
...
Finally, we can call any `marginaleffects` function and obtain results. Notice that our object of class `customclass` now produces different results than the default `mblogit` object: `model_custom
