...
1. Compute [marginal effects and contrasts at the mean (or other representative value)](https://vincentarelbundock.github.io/marginaleffects/articles/slopes.html#marginal-effect-at-user-specified-values) instead of all observed rows of the original dataset: Use the `newdata` argument and the `datagrid()` function.
...
The `slopes` functions are relatively fast. This simulation was conducted using the development version of the package on 2022-04-04:
