...
1. Only compute marginal effects for a subset of variables, paying special attention to exclude factor variables which can be particularly costly to process: `variables` argument.
2. Do not compute standard errors: `vcov = FALSE` argument.
3. Parallel computation (see section below).
