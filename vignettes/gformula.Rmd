...
2. Highlight the equivalence between one form of g-estimation and the ["Average Contrasts"](https://vincentarelbundock.github.io/marginaleffects/articles/contrasts.html#average-contrasts) computed by `marginaleffects`
...
```{r}
comparisons(std, variables = list(qsmk = 0:1)) |>
  averages()
```
