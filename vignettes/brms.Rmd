...
Use `marginaleffects()` to [compute marginal effects (slopes of the regression equation)](https://vincentarelbundock.github.io/marginaleffects/articles/mfx02_mfx.html) for each row of the dataset, and use `summary()` to compute "Average Marginal Effects", that is, the average of all observation-level marginal effects: 
...
comparisons(
    ...
    type = "link",
    variables = "lifeExp",
    newdata = datagrid(lifeExp = c(40, 70), grid.type = "counterfactual")) %>%
    posteriordraws() %>%
