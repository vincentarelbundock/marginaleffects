...
Population-averaged (aka "marginal") adjusted risk difference ([see this vignette](https://vincentarelbundock.github.io/marginaleffects/articles/gformula.html)) can be obtained using the `summary()` function:
