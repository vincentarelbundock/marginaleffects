...
To estimate a quantity of interest, we define the following logistic regression model estimated using the Titanic mortality data:
...
```{r, eval = FALSE}
comparisons(mod, variables = list(PClass = c("1st", "3rd")))
```
