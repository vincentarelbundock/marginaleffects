...
Note that the two results are exactly identical when we specify `type="response"` explicitly. However, they will differ slightly when we leave `link` unspecified, because `marginaleffects` will then automaticaly make predictions and average on the link scale, before backtransforming:
