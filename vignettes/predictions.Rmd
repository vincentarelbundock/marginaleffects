...
An adjusted prediction is thus the regression-adjusted response variable (or link, or other fitted value), for a given combination (or grid) of predictors. This grid may may or may not correspond to the actual observations in a dataset.
