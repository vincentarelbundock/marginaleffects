...
```{r}
predictions(mod, newdata = typical())
...
An alternative function to construct grids of predictors is to use `counterfactual()`. This function will duplicate the *whole* dataset, with the different values specified by the user. 
...
nd <- counterfactual(model = mod, am = 0:1)
