...
from plotnine import geom_segment, geoms, aes
```
...
```{python, echo = FALSE}
plot = plot_predictions(fit, by = ["vs", "am"]) +\
  geom_segment(mapping=aes(x = 0, y = 15.1, xend = 0.9, yend = 20.7), arrow=geoms.arrow(type = "closed"))
...
```{python, echo = FALSE}
plot = plot_predictions(fit, by = ["vs", "am"]) +\
  geom_segment(mapping=aes(x = 0, y = 15.1, xend = 0, yend = 19.7), arrow=geoms.arrow(type = "closed"))
...
```{python, echo = FALSE}
plot = plot_predictions(fit, by = ["vs", "am"]) +\
  geom_segment(mapping=aes(x = 1, y = 20.7, xend = 1, yend = 28.4), arrow=geoms.arrow(type = "closed"))
...
```{python, echo = FALSE}
plot = plot_predictions(fit, by = ["vs", "am"]) +\
  geom_segment(mapping=aes(x = 0, y = 15.1, xend = 1, yend = 28.4), arrow=geoms.arrow(type = "closed"))
