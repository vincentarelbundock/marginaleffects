...
```{r}
plot_comparisons(mod,
  effect = list("flipper_length_mm" = "sd"),
  condition = c("bill_length_mm", "species")) +

plot_comparisons(mod,
  effect = list("flipper_length_mm" = 10),
  condition = c("bill_length_mm", "species"))
```
...
plot_slopes(mod2, effect = "qsec", condition = c("wt", "gear"))
```
...
# More customization: Raw data & `ggplot2`
