...
We can also use `margins` to compute "counterfactual average marginal effects" for different subsets of the data (see the `Stata` section for identical results):
