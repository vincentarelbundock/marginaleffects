...
`effects` also offers several options which are not available in `marginaleffects`, including:

* Partial residuals plots
* Many types of plots. See the [package's excellent vignette](https://cran.r-project.org/web/packages/effects/vignettes/predictor-effects-gallery.pdf)
