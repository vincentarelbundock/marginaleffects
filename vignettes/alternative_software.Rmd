...
plot_comparisons(m, effect = "am", condition = "wt")
...
+ `effects` focuses on the computation of ["adjusted predictions."](https://vincentarelbundock.github.io/marginaleffects/articles/predictions.html) The plots it produces are roughly equivalent to the ones produced by the `plot_predictions` and `predictions` functions in `marginaleffects`.
