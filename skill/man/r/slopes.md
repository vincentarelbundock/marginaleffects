...
<ul>
<li> <code>slopes()</code>: unit-level (conditional) estimates.

</li>
<li> <code>avg_slopes()</code>: average (marginal) estimates.
...
<ul>
<li> <a href="https://marginaleffects.com/chapters/slopes.html">https://marginaleffects.com/chapters/slopes.html</a>
...
Warning: Slopes and elasticities can only be calculated for continuous numeric variables. The <code>slopes()</code> functions will automatically revert to <code>comparisons()</code> for binary or categorical variables.
...
<ul>
<li> <code>NULL</code>: compute slopes or comparisons for all the variables in the model object (can be slow).
...
Numerical derivatives for the <code>slopes</code> function are calculated
...
<ul>
<li> <code>avg_slopes()</code>: Average slopes
