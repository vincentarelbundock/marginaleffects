...
expect_equivalent(tid$estimate, tid.b$estimate, tolerance = 0.01)
expect_equivalent(tid$conf.low, tid.b$conf.low, tolerance = 0.1)
expect_equivalent(tid$conf.high, tid.b$conf.high, tolerance = 0.1)