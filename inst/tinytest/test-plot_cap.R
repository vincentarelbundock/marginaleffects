...
expect_snapshot_plot(p, "plot_cap")
...
expect_snapshot_plot(p, "plot_cap_vs_categorical_x_axis")
p <- plot_cap(mod, condition = c("wt", "cyl"))
expect_snapshot_plot(p, "plot_cap_vs_continuous_x_axis")
...
expect_snapshot_plot(p1, "plot_cap_conf_99")
expect_snapshot_plot(p2, "plot_cap_conf_40")
...
expect_snapshot_plot(p1, "plot_cap_response")
expect_snapshot_plot(p2, "plot_cap_link")
