...
p <- plot_slopes(mod, effect = "bill_length_mm", condition = "flipper_length_mm", draw = FALSE)
...
mfx1 <- plot_slopes(mod, effect = "hp", condition = "wt", draw = FALSE)
mfx2 <- plot_slopes(mod, effect = "hp", condition = "wt", vcov = "HC3", draw = FALSE)
mfx3 <- plot_slopes(mod, effect = "hp", condition = "wt", vcov = ~cyl, draw = FALSE)
