...
expect_equivalent(mfx[mfx$term == "linc", "estimate"], as.numeric(mar$estimate_linc), tolerance = tol)
expect_equivalent(mfx[mfx$term == "educ", "estimate"], as.numeric(mar$estimate_educ), tolerance = tol)
expect_equivalent(mfx[mfx$term == "age", "estimate"], as.numeric(mar$estimate_age), tolerance = tol)
