...
hypothesis : str, int, float, list of str, numpy array
    ...
    - numpy.ndarray:
        Each column is a vector of weights. The output is the dot product between these vectors of weights and the vectors of estimates. e.g. ``hypothesis=np.array([[1, 1, 2], [2, 2, 3]]).T``
    - See the Examples section and the vignette: https://marginaleffects.com/chapters/hypothesis.html"""

PARAM_BY = """\
by : bool or list of str, optional
...
PARAM_VCOV = """\
vcov : bool or numpy.ndarray, default True
    ...
    - numpy.ndarray: A custom square covariance matrix."""

PARAM_EQUIVALENCE = """\
equivalence : list, optional
    List of 2 numeric float values specifying the bounds used for the two-one-sided test (TOST) of equivalence, and for the non-inferiority and non-superiority tests. See the Notes section below."""
...
variables : str, list, or dict
    ...
    - list of str or str: List of variable names to compute predictions for.
    - dict: keys identify the subset of variables of interest, and values define the type of contrast to compute. Acceptable values depend on the variable type:
...
variables : str, list, or dict
    ...
    - list of str or str: List of variable names to compute comparisons for.
    - dict: keys identify the subset of variables of interest, and values define the type of contrast to compute. Acceptable values depend on the variable type:
...
condition : str, list, or dict
    ...
    - dict: Keys correspond to predictors. Values can be one of the two below depending on predictor's type:

      - Series or list of the same type as the original variable.
      - Numeric variables:

        - String: "minmax", "threenum", "fivenum".
    - str: Same as list of length 1."""
...
-------
ModelStatsmodels
    A fitted model wrapped in the ModelStatsmodels class for compatibility with marginaleffects."""

MODELS_FIT_RETURNS_SKLEARN = """\
Returns
-------
ModelSklearn
    A fitted model wrapped in the ModelSklearn class for compatibility with marginaleffects."""

MODELS_FIT_RETURNS_LINEARMODELS = """\
Returns
-------
ModelLinearmodels
    A fitted model wrapped in the ModelLinearmodels class for compatibility with marginaleffects."""
