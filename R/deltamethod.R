...
#' @param model Model object or object generated by the `comparisons()`, `marginaleffects()`, or `predictions()` functions.
...
deltamethod <- function(
    ...
    if (inherits(model, c("comparisons", "marginaleffects", "predictions"))) {
