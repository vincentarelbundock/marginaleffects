...
#' @param hypothesis specify a hypothesis test or custom contrast using a numeric value, vector, or matrix; a string equation; string; a formula, or a function.
#' + Numeric:
...
#'   - Right-hand side determines the pairs of estimates to compare: `reference`, `sequential`, `meandev`, or `poly`.
