...
#'   - See examples below.
#'   - For more complex aggregations, you can use the `hypoth_fun` argument of the `hypotheses()` function. See that function's documentation and the Hypothesis Test vignettes on the `marginaleffects` website.
#' @param cross
