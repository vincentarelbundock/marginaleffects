...
* _Extensibility:_ Adding support for new models often requires less than 10 lines of new code. In the medium run, my goal is to add support for *several* more model types.
