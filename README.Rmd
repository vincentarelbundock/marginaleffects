...
* _Powerful:_ Marginal effects and contrasts can be computed for about `r n_support` different kinds of models. Adjusted predictions and marginal means can be computed for about 100 model types. 
...
[The Contrasts vignette](https://vincentarelbundock.github.io/marginaleffects/articles/mfx03_contrasts.html) shows how to use the `comparisons()` function to compute a wide variety of quantities of interest:
...
[The Marginal Effects vignette](https://vincentarelbundock.github.io/marginaleffects/articles/mfx02_mfx.html) shows how to use the `marginaleffects()` function to compute a wide variety of quantities of interest:
