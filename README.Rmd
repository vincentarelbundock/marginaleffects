...
* _User interface:_ Related functions are incorporated in a simple, unified, and well-documented interface.
...
```{r}
plot_cme(mod, effect = "bill_length_mm", condition = "flipper_length_mm", draw = FALSE)
```
