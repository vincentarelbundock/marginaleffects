...
To calculate marginal effects, we take the derivative of the regression equation. This can be challenging, especially when our models are non-linear, or when regressors are transformed or interacted. Computing the variance is even more difficult. The `marginaleffects` package hopes to do most of this hard work for you.
